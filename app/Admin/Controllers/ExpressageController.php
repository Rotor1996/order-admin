...
//        });
        ...
        $grid->column('pay_way','支付方式')->label();
        ...
        $grid->column('client.money_end_way','尾款支付方式')->using(Expressage::getMoneyWay())->label();
...
//        $grid->column('client.source','来源');
    ...
    protected function form()
    {
        ...
        $form->select('client.money_way', '尾款支付方式')->options(Expressage::getMoneyWay());
